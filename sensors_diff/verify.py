...
from git_autograder.answers.rules import HasExactValueRule, NotEmptyRule, HasExactListRule
...
QUESTION_FOUR = "Which new values are new in north.csv on Jan 10th, compared to Jan 01st?"
...
def verify(exercise: GitAutograderExercise) -> GitAutograderOutput:    
    (
        ...
        .add_validation(
            QUESTION_ONE,
            HasExactValueRule("7590", is_case_sensitive=True))
        .add_validation(
            QUESTION_TWO,
            NotEmptyRule(),
        ...
        .add_validation(
            QUESTION_THREE,
            NotEmptyRule(),
            HasExactListRule(["north.csv", "south.csv", "west.csv"], is_case_sensitive=True))
        .add_validation(
            QUESTION_FOUR,
            NotEmptyRule(),
