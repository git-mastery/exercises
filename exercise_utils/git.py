...
# named it pull_branch to indicate that branch must be specified
def pull_branch(remote: str, branch: str, verbose: bool) -> None:
    """Pull from the given branch on the remote"""
    run_command(["git", "pull", remote, branch], verbose)
