...
# TODO [@jovnc]: refactor functions using this to use functions above instead of running gh commands directly
@deprecated("This function is deprecated. Please use get_github_username instead.")
...
@deprecated("This function is deprecated. Please use has_repo instead.")
def _has_repo(repo_name: str, is_fork: bool, verbose: bool) -> bool:
    """Returns if the given repository exists under the current user's repositories."""
...
@deprecated("This function is deprecated. Please use has_fork instead.")
def _has_fork(
...
@deprecated("This function is deprecated. Please use get_fork_name instead.")
def _get_fork_name(
    repository_name: str, owner_name: str, username: str, verbose: bool
) -> str:
    """Returns the name of the current user's fork repo"""
...
# TODO [@jovnc]: refactor functions below to use RepoSmith object instead of running gh commands directly
